...
namespace H.Core.DataAccess
{
    ...
    public class DataCommand
    {
        ...
        public void InnerAddInputParameter(string name, DbType dbType, object value)
        {
        ...
        public void InnerAddInputParameter(string name, DbType dbType)
        {
            DbParameter p = m_Factory.CreateParameter();
            p.ParameterName = name;
            p.DbType = dbType;
        ...
        public void InnerAddOutParameter(string name, DbType dbType, int size)
        {
            DbParameter p = m_Factory.CreateParameter();
            p.ParameterName = name;
            p.DbType = dbType;
        ...
        private void ConvertColumnFromRow(DataRow row, EnumColumnList enumColumns, CodeNamePairColumnList codeNamePairColunms)
        {
            ...
            if (codeNamePairColunms != null && codeNamePairColunms.Count > 0)
            {
                foreach (var entry in codeNamePairColunms)
                {
                    ...
                    string code = row[columnIndex].ToString().Trim();
