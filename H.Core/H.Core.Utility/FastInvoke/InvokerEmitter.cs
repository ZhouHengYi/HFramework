...
namespace H.Core.Utility
{
    ...
    internal class InvokerEmitter : IMethodEmit
    {
        ...
        {
            MethodInfo[] methodArray = GetMethodsExcludePropertyMethod(m_InvokedType, m_BindingFlags);
            if (methodArray == null || methodArray.Length <= 0)
            {
        ...
        private MethodInfo[] GetMethodsExcludePropertyMethod(Type type, BindingFlags bindingAttr)
        {
