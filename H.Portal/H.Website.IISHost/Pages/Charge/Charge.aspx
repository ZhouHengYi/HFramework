<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="Charge.aspx.cs" Inherits="H.Website.IISHost.Pages.Charge.Charge" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Content" runat="server">
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Home</a> <a href="#" class="current">收费标准</a></div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Bottom" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            bindHelper.AjaxProObject = Portal.Charge;
            bindHelper.init();
        });

        var cg = {
            maintain: function (sysNo) {
                $.showWindow('收费标准维护', '<%=BuildUrl(H.Website.Facade.PageAlias.ChargeMaintain)%>?sysNo=' + sysNo + '&timer=' + new Date().getDate(), 700, 565);
            }, add: function () {
                $.showWindow('添加收费标准', '<%=BuildUrl(H.Website.Facade.PageAlias.ChargeMaintain)%>?timer=' + new Date().getDate(), 700, 565);
            },
            deleteSel: function () {
