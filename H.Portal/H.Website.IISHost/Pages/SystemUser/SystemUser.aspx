<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/Master.Master" CodeBehind="SystemUser.aspx.cs" Inherits="H.Website.IISHost.Pages.SystemUser.SystemUser" %>
                ...
                <tr>
                    <td width="40%">
                        <label style="padding-left: 2%;">
                            用户名:
                                <input type="text" style="margin-left: 10px;" data-name="UserName"></label></td>
                    <td width="50%">
                        <label>
                            创建日期:
                            ...
                            <table class="table table-bordered data-table dataTable" id="tbl_List">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td bind="$.SysNo" width="5%" style="text-align: center;">
                                        <a href="javaScript:systemUser.maintain($.Value)">查看</a>
                                    </td>
                                </tr>
                            </table>
    ...
    <script type="text/javascript">
        ...
        var systemUser = {
            maintain: function (sysNo) {
                $.showWindow('用户信息维护', '<%=BuildUrl(H.Website.Facade.PageAlias.SystemUserMaintain)%>?sysNo=' + sysNo + '&timer=' + new Date().getDate(), 700, 365);
            },
            deleteSel: function () {
